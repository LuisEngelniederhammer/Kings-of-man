...
App =
  {
    BaseClassObject = nil,
    DayCycleClassObject = nil,
    GameClassObject = {},
    BuildingClassObject = nil,
...
function App:new(o)
  ...
  setmetatable(o, self)
  self.__index = self
  self.currentGameState = self.GameState.mainmenu;
  self.BaseClassObject = Base:new(nil,10,1,10,1,10);
...
-- "mainmenu", "pause"/"esc", "running"
function App:setGameState(var)
  self.currentGameState = var;
end
---
---
----
